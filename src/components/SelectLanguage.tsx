      ...
      {noPracticeNow && (
        <>
          <div className="mt-10 mx-auto max-w-xl rounded border border-orange-400 bg-black/40 px-6 py-10 text-center font-mono backdrop-blur-sm shadow-[0_0_10px_rgba(251,146,60,0.5)]">
            ...
            <p className="mb-6 text-sm leading-relaxed text-emerald-100/50">Add more entries to your dictionary, or return when the next review for this language becomes due.</p>
