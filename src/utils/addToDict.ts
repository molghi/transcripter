...
export function addToDict(selectionPopup: SelectionPopup, closestSentence: string | null, translations: string[], selectedLanguage: string, videoName: string, videoUrl: string) {
  ...
  console.log(localStorage.getItem(LOCAL_STORAGE_KEYS.VOCABULARY));
}
